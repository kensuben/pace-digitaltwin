...
- Done: scenario-scoped Virtual Machine inventory on physical SERVER devices, with rack-level resource summary, CRUD management and clone lifecycle support.
